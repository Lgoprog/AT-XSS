...
def SearchInputInResponse_2(input, body):
    parse = MyHTMLParser() ##先生成html解析树
    parse.feed(body)
    tokens = parse.getTokenizer()
    index = 0
...
if __name__=='__main__':
    ...
    url = "http://192.168.77.130:8080/xss/reflect/textarea2?in=%3Cscript%3Ealert%281%29%3C%2Fscript%3E"
    r = requests.get(url)
    print(SearchInputInResponse_2('alert',r.text))
